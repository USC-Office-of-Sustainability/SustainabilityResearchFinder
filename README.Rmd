...
2. Due to GitHub file size limitations, the complete USC research data could not be completely uploaded to the repository. As a result, the large data files are stored here [Complete Data Files on Google Drive](https://drive.google.com/drive/folders/1FCNpPjeOBa0_kFAvGWjBKQ6TDEydviDi?usp=sharing){target="_blank"}. Please download all three folders ("data_processed", "data_raw", "shiny_app") and put them in the "Dashboard" folder of the cloned repository. You may be asked whether to replace those folder, and please click "replace", as the folders on Google Drive contain the most complete data. The folder structure should look like this:
